    ...
    Column() {
        Row(modifier = Modifier.padding(start = 10.dp)) {
            ...
            Column(Modifier.padding(start = 16.dp)) {
                Text(text = "A review by Tony Stark", fontWeight = FontWeight.Bold, fontSize = 20.sp, )
                Spacer(modifier = Modifier.padding(5.dp))
                Text(text = "Written by Tony Stark on January 12, 2020", fontSize = 14.sp, color = Color.LightGray )
            }
        }
