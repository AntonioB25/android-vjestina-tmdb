...
//    suspend fun getSearchMovie(query: String): MovieSearchResponse
    ...
    suspend fun getNowPlayingMovies(): Flow<MovieListResponse>
    suspend fun getUpcomingMovies(): Flow<MovieListResponse>
    suspend fun getTopRatedMovies(): Flow<MovieListResponse>
    suspend fun getMovieDetails(movieId: Int): Flow<MovieDetailsResponse>
    suspend fun getMovieCredits(movieId: Int): Flow<MovieCreditsResponse>
    suspend fun getSearchMovie(query: String): Flow<MovieSearchResponse>
}
...
internal class MovieApiImpl(
    ...
    override suspend fun getNowPlayingMovies(): Flow<MovieListResponse> =
        client.get(
            "${HttpRoutes.NOW_PLAYING_MOVIES}?api_key=${HttpRoutes.API_KEY}"
        )

    override suspend fun getUpcomingMovies(): Flow<MovieListResponse> =
        client.get(
            "${HttpRoutes.UPCOMING_MOVIES}?api_key=${HttpRoutes.API_KEY}"
        )

    override suspend fun getTopRatedMovies(): Flow<MovieListResponse> =
        client.get(
    ...
    override suspend fun getMovieCredits(movieId: Int): Flow<MovieCreditsResponse> =
        client.get(
            "${HttpRoutes.BASE_URL}/movie/$movieId/credits?api_key=${HttpRoutes.API_KEY}"
        )

    override suspend fun getSearchMovie(query: String): Flow<MovieSearchResponse> =
        client.get(
